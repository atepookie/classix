...
while True:
    ...
    if console == "exit":
        ...
        while True:
            ...
            Pig.indent(0, 39)
            write("Move the required file to the Classix folder", align="left", font=("Verdana", User.fontsize, "normal"))

            Pig.indent(0, 39)
            write("Enter an app path in opened console or...", align="left", font=("Verdana", User.fontsize, "normal"))
